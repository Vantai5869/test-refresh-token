...
app.get('/api/cat',requireAuth, async (req, res) => {
   const response = await axios.get('https://source.unsplash.com/random?rand=1', { responseType:"arraybuffer" })
...
async function connect() {
  try {    
    ...
    await mongoose.connect("mongodb+srv://taipv:mgtaipv00@hero.538dt.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", {
